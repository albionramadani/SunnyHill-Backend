...
{
    public class AuthorizationMenager : IAuthorizationManager
    {
        private readonly ClaimsPrincipal calaimsPrinclipal;
        private readonly IHttpContextAccessor _contextAccessor;
        public string ClaimTypeName => "Id";

        public AuthorizationMenager(ClaimsPrincipal calaimsPrinclipal, IHttpContextAccessor httpContextAccessor)
        {
